  ...
  return (
    <div className="stock">
      ...
      <div className="stock-lower" style={{ marginTop: 16 }}>
        ...
        {/* ---------- news: a persistent right rail on desktop, the way
            Bloomberg/Yahoo Finance keep headlines visible next to the
            readings instead of at the bottom of a long scroll ---------- */}
