 ...
 *
 * Styled as filled brand-colour badges rather than plain outline glyphs —
 * the one other place (besides the CTA and the landing popup) allowed to be
 * loud, since a footer icon row is decoration, not a reading surface the
 * calm palette exists to protect.
 */
      ...
      {LINKS.map((l) => (
        ...
        >
          <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true">
            {l.name === "X" ? (
              <path d={l.path} fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" />
            ) : (
